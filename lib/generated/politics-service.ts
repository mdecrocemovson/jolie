...
export type GetPoliticianQuery = {
  ...
  fetchPolitician?: {
    ...
    party?: { __typename?: "Party"; name?: string | null } | null;
  } | null;
};
...
>(
  ...
  useQuery<GetPoliticianQuery, TError, TData>(
    ...
    fetcher<GetPoliticianQuery, GetPoliticianQueryVariables>(
      client,
      GetPoliticianDocument,
      variables,
      headers
    ),
    options
...
useGetPoliticianQuery.getKey = (variables: GetPoliticianQueryVariables) => [
  "GetPolitician",
  variables,
];
useGetPoliticianQuery.fetcher = (
  client: GraphQLClient,
  variables: GetPoliticianQueryVariables,
  headers?: RequestInit["headers"]
) =>
